...
const translations = {
  ...
  uk: {
    ...
    resumeCompetency1: "Розробка full-stack додатків",
    ...
    servicesFullstackDescription: "Розробка додатків від проектування бази даних до користувацького інтерфейсу. ASP.NET Core backend з React frontend, забезпечуючи безшовну інтеграцію та оптимальну продуктивність.",
